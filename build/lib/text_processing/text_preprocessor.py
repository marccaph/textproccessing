...
class TextPreprocessor:
    ...
    def __init__(self, remove_links=True, remove_hastags=True,
                  ...
                  remove_stopwords_flag= True, perform_stemming=True, 
        ...
        self.perform_stemming_flag= perform_stemming
        self.perform_lemmatization_flag= perform_lemmatization
    ...
    def preprocess_text(self, text):
        ...
        if self.perform_stemming_flag:
            text = self.perform_stemming(text)
        if self.perform_lemmatization_flag:
